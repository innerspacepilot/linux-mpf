...
sha256sums=('de416e87b6330686ccb13c7249acb16dabaea145420315237053c7d466064a82'
            'SKIP'
            '6389c2e617a8b2f6d396d87dba94694f8f78288956978278d0fcc70adf44f117')
...
prepare() {
  ...
  echo "${pkgbase#linux}${_pfrel}" > localversion.20-pkgname
